...
},{}],"nb.js":[function(require,module,exports) {
"use strict";
...
var _perlin = _interopRequireDefault(require("./perlin"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var nb = function nb(_ref) {
  var dom = _ref.dom,
      sparse = _ref.sparse,
  ...
  canvas.height = getComputedStyle(dom)['height'];
  canvas.width = getComputedStyle(dom)['width'];
  ...
  Point.prototype.line = function () {
    ...
    var s = _perlin.default.simplex3(this.cx / scale, this.cy / scale, seed);

    var sa = Math.abs(s);
    context.strokeStyle = "rgb(".concat(255 * sa, ", ").concat(192 * sa, ", ").concat(203 * sa, ")");
  ...
  for (var y = 0; y < size; y += singleSpan) {
    for (var x = 0; x < size; x += singleSpan) {
...
},{"./perlin":"perlin.js"}],"../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","nb.js"], null)
//# sourceMappingURL=/nb.a7193dbf.map